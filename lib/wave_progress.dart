        ...
        child: new AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            return new CustomPaint(
              painter: WaveProgressPainter(controller, widget.borderColor, widget.fillColor, widget.progress),
            );
          },
        ),
      ),
...
class CircleClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    return Path()..addOval(new Rect.fromCircle(center: new Offset(size.width / 2, size.height / 2), radius: size.width / 2));
  }
